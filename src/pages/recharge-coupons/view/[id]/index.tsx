...
import { getRechargeCouponById } from 'apiSdk/recharge-coupons';
import { RechargeCouponInterface } from 'interfaces/recharge-coupon';

function RechargeCouponViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Recharge Coupon Details
                  </Text>
                </Box>
                {hasAccess('recharge_coupon', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/recharge-coupons/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Validity" text={data?.validity} />
