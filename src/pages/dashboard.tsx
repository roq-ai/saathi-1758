...
import { getCustomerServiceRepresentatives } from 'apiSdk/customer-service-representatives';
...
import { RechargeCouponListPage as ShowCaseList } from 'pages/recharge-coupons';
...
function DashboardPage() {
  ...
  const customerServiceRepresentativeStat = useSWR<PaginatedInterface<CustomerServiceRepresentativeInterface>>(
    () => `/customer-service-representatives`,
    () => getCustomerServiceRepresentatives({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: customerServiceRepresentativeStat?.data?.totalCount,
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Recharge Coupons
                </Text>
                <NextLink href={`recharge-coupons`} passHref legacyBehavior>
                  <Button
