  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Saathi - Your safe space for mental health support. Engage in anonymous chats, share your secrets and recharge your mind with our unique coupons."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1564121211835-e88c852648ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZW50YWwlMjBoZWFsdGh8ZW58MHx8fHwxNjk0MDE4NDM5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dmey503?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dan Meyers`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Saathi - Your safe space for mental health support. Engage in anonymous chats, share your secrets and recharge your mind with our unique coupons.`}
            </Text>
            <Box
