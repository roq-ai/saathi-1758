...
export function OrganizationListPage(props: OrganizationListPageProps) {
    ...
    async () =>
      getOrganizations({
        relations: [
          'user',
          'customer.count',
          'customer_service_representative.count',
          'recharge_coupon.count',
          'team_member.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('customer_service_representative', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('recharge_coupon', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'recharge_coupon',
          header: 'Recharge Coupon',
          accessorKey: 'recharge_coupon',
          cell: ({ row: { original: record } }: any) => record?._count?.recharge_coupon,
        }
      : null,
